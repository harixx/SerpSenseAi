...
export default function Home() {
  ...
  const calculateROI = (traffic: number, spend: number) => {
    ...
    const additionalRevenue =
      additionalTraffic * conversionRate * avgOrderValue;
    const monthlyROI =
      ((additionalRevenue - imperiusCost) / imperiusCost) * 100;
  ...
  const waitlistMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description:
          "You'll receive priority access and strategic onboarding when we launch.",
        duration: 5000,
      });
    ...
    const startAudioOnInteraction = (e: Event) => {
      ...
      const isAudioToggle =
        target && typeof target.closest === "function"
          ? target.closest("[data-audio-toggle]")
          : false;
      ...
      if (audioRef.current) {
        ...
        if (playPromise !== undefined) {
          playPromise
            ...
            .catch((e) => {
              logger.log(
                "Real audio failed via toggle, using synthetic:",
                e.message,
              );
              // Fallback to synthetic
              if (f1AudioEngine.current) {
    ...
    <div className="min-h-screen text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <video
          ...
          onLoadedData={(e) => {
            logger.log(
              "F1 racing video loaded successfully from:",
        ...
        >
          <source
            src="/attached_assets/5cf22b7b7ee772d0a22fefbd4da43ab3-720p-preview_1753110183979.mp4"
            type="video/mp4"
          />
          <source
        ...
        <video
          ...
          onError={(e) => {
            logger.log(
              "Backup video failed to load, using animated background",
            );
            e.currentTarget.style.display = "none";
            const fallback = e.currentTarget.nextElementSibling as HTMLElement;
            if (fallback) fallback.style.display = "block";
        ...
        <div
          className="w-full h-full racing-background"
          style={{ display: "none" }}
        >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center bottom, rgba(220, 38, 38, 0.08) 0%, transparent 60%)",
            pointerEvents: "none",
            zIndex: 6,
          }}
        ></div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at top left, rgba(0, 0, 0, 0.95) 0%, rgba(0, 0, 0, 0.7) 50%, transparent 80%)",
            pointerEvents: "none",
            zIndex: 20,
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at top right, rgba(0, 0, 0, 0.95) 0%, rgba(0, 0, 0, 0.7) 50%, transparent 80%)",
            pointerEvents: "none",
            zIndex: 20,
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at bottom left, rgba(0, 0, 0, 0.95) 0%, rgba(0, 0, 0, 0.7) 50%, transparent 80%)",
            pointerEvents: "none",
            zIndex: 20,
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at bottom right, rgba(0, 0, 0, 0.95) 0%, rgba(0, 0, 0, 0.7) 50%, transparent 80%)",
            pointerEvents: "none",
            zIndex: 20,
          }}
        ></div>
        ...
        <div
          ...
          style={{
            ...
            height: "150px",
            background:
              "linear-gradient(45deg, rgba(10, 10, 10, 1) 0%, rgba(10, 10, 10, 0.8) 50%, transparent 100%)",
            pointerEvents: "none",
            zIndex: 35,
          }}
        ></div>
        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              className={
                audioEnabled
                  ? "bg-crimson hover:bg-ruby text-white"
        ...
        <div className="container mx-auto px-6 text-center relative z-20">
          ...
          >
            ...
            >
              ...
              <em className="text-crimson font-medium">why</em> pages rank—not
              just who ranks. Uncover the hidden signals: tone, sentiment, UX
              patterns, and content depth.
            </motion.p>

            <motion.div
              variants={fadeInUp}
              className="glassmorphism p-8 rounded-2xl max-w-lg mx-auto mb-8"
            >
              <h3 className="font-playfair text-2xl font-semibold mb-4 text-white">
                Join the Elite Waitlist
              </h3>
              <p className="text-white/70 mb-6">
                Limited access. Strategic advantage.
              </p>

              <Form {...heroForm}>
                <form
                  ref={heroFormRef}
                  onSubmit={heroForm.handleSubmit(onSubmit)}
                  className="space-y-4"
                  id="hero-form"
                >
                  <FormField
                  ...
                  >
                    {waitlistMutation.isPending
                      ? "Processing..."
                      : heroCTA.config?.text || "Request Exclusive Access"}
                  </Button>
                </form>
              </Form>
      ...
      <section className="py-20 bg-obsidian/50 relative z-10 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              className="text-xl max-w-3xl mx-auto text-[#e5e7eb] space-y-6"
            >
              ...
              <div className="space-y-4 text-lg">
                <div>
                  🔍 Others chase rankings. We uncover the why behind them.
                </div>
                <div>
                  🧠 We decode intent. Not just search terms, the strategy
                  behind what's winning.
                </div>
                <div>
                  📖 Every page tells a story. We reveal the plot that drives
                  visibility and trust.
                </div>
                <div>
                  🚀 No guesswork. No fluff. Just data-driven insight that
                  impacts revenue.
                </div>
              </div>
              ...
              <div className="text-lg">
                Get a custom strategy backed by real search intelligence not
                assumptions.
              </div>
                ...
                <CardContent className="p-0 space-y-4">
                    ...
                    <CardContent className="p-0">
                      <div className="flex justify-between items-start mb-2">
                        <h5 className="text-white font-medium">
                          Advanced SEO Strategies Guide
                        </h5>
                        <span className="text-xs bg-crimson/20 text-crimson px-2 py-1 rounded">
                          92% Match
                        </span>
                      </div>
                      <p className="text-sm mb-3 text-[#e7b008]">
                        Comprehensive guide covering technical and content
                        optimization...
                      </p>
                  ...
                  <Card className="glassmorphism p-4 rounded-lg border border-crimson/20 feature-card">
                    <CardContent className="p-0">
                      ...
                      <p className="text-sm mb-3 text-[#e7b008]">
                        Updated strategies for modern search engine
                        optimization...
                      </p>
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div className="flex items-center">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#e7b008]">
                          Analyzes tone, sentiment, UX patterns, content
                          structure, and topical depth—not just keywords and
                          backlinks.
                        </p>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#e7b008]">
                          Cross-reference rankings by keyword, location, device
                          type, and search intent for surgical precision.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#e7b008]">
                          Receive actionable, intelligence-driven tactics that
                          help you outperform—not just optimize.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#e7b008]">
                          Transform competitor analysis from guesswork into
                          scientific advantage with LLM-powered insights.
                        </p>
                      </div>
                    </div>
                  </CardContent>
      ...
      <section className="py-20 bg-charcoal relative z-10 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-xl text-platinum/70 max-w-3xl mx-auto"
            >
              Strategic SEO teams demand more than surface-level data. Here's
              how elite professionals leverage Imperius.
            </motion.p>
          </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="glassmorphism p-8 rounded-2xl feature-card h-full">
                <CardContent className="p-0">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold mb-4 text-[#e7b008] text-center">
                    Enterprise SEO Leads
                  </h3>
                  <p className="mb-6 text-[#e5e7eb]">
                    "Instead of guessing why competitors rank, I can
                    reverse-engineer their exact content strategy—tone, depth,
                    UX patterns—and build superior alternatives."
                  </p>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="glassmorphism p-8 rounded-2xl feature-card h-full">
                <CardContent className="p-0">
                  ...
                  <h3 className="font-playfair text-2xl font-semibold mb-4 text-center text-[#e7b008]">
                    Digital Agencies
                  </h3>
                  <p className="mb-6 text-[#e5e7eb]">
                    "Client presentations transformed overnight. We now deliver
                    concrete intelligence about why their competitors dominate
                    specific niches—and how to beat them."
                  </p>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-crimson font-medium">
                      Client Impact
            ...
            <motion.div variants={fadeInUp}>
              <Card className="glassmorphism p-8 rounded-2xl feature-card h-full">
                <CardContent className="p-0">
                  ...
                  <p className="mb-6 text-[#e5e7eb]">
                    "Finally, data-driven content direction. I can identify the
                    exact sentiment, tone, and depth that drives rankings in any
                    niche—then optimize accordingly."
                  </p>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-crimson font-medium">
                      Content Precision
                ...
                <CardContent className="p-0">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#e7b008]">
                        SEO Director, TechCorp
                      </p>
                    </div>
                  </div>
                  <blockquote className="italic mb-4 text-[#e5e7eb]">
                    "This completely changed how we approach competitive
                    analysis. We're not just tracking rankings—we're
                    understanding the strategic thinking behind them."
                  </blockquote>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="glassmorphism p-8 rounded-2xl feature-card h-full">
                <CardContent className="p-0">
                  ...
                  <blockquote className="italic mb-4 text-[#e5e7eb]">
                    "Our client retention increased 40% after implementing
                    insights from Imperius. The strategic depth is unmatched."
                  </blockquote>
                  <div className="flex items-center text-gold text-sm">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current mr-1" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="glassmorphism p-8 rounded-2xl feature-card h-full">
                <CardContent className="p-0">
                  ...
                  <blockquote className="italic mb-4 text-[#e5e7eb]">
                    "Finally, a tool that explains the 'why' behind rankings.
                    Our content team now creates with surgical precision instead
                    of educated guesses."
                  </blockquote>
                  <div className="flex items-center text-gold text-sm">
                    {[...Array(5)].map((_, i) => (
      ...
      <section className="py-20 bg-gradient-to-br from-obsidian/80 via-black/90 to-obsidian/80 relative z-10 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-xl text-platinum/80 mb-12 max-w-3xl mx-auto"
            >
              Join industry leaders who've transformed their SEO strategy with
          ...
          >
            <Card className="glassmorphism p-8 rounded-2xl relative overflow-hidden">
              ...
              <CardContent className="p-0">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-xs text-platinum/60">
                    Enterprise Client
                  </span>
                </div>
                <blockquote className="text-lg text-white mb-6 font-light italic">
                  "Imperius revealed why our competitors were outranking us
                  despite having fewer backlinks. The content tone and structure
                  insights helped us redesign our approach and achieve 3x
                  organic growth in 6 months."
                </blockquote>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-platinum/60 text-sm">
                      Head of SEO, TechScale Ventures
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="glassmorphism p-8 rounded-2xl relative overflow-hidden">
              ...
              <CardContent className="p-0">
                ...
                <blockquote className="text-lg text-white mb-6 font-light italic">
                  "Traditional tools show what's ranking. Imperius shows why
                  it's ranking. This depth of analysis has become our
                  competitive differentiator and increased our client LTV by
                  40%."
                </blockquote>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-crimson to-ruby rounded-full flex items-center justify-center text-white font-semibold">
            ...
            <Card className="glassmorphism p-8 rounded-2xl relative overflow-hidden">
              ...
              <CardContent className="p-0">
                ...
                <blockquote className="text-lg text-white mb-6 font-light italic">
                  "The multi-dimensional analysis helped us identify content
                  gaps our competitors missed. We captured market share in three
                  key verticals within 90 days of implementation."
                </blockquote>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-crimson to-ruby rounded-full flex items-center justify-center text-white font-semibold">
                    PW
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-platinum/60 text-sm">
                      VP Content Strategy, InnovateFlow
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <motion.h2
              ...
              className="font-playfair text-4xl lg:text-5xl font-bold text-white mb-6"
            >
              Calculate Your <span className="text-crimson">Strategic ROI</span>
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-xl text-platinum/80 mb-12 max-w-3xl mx-auto"
            >
              See how Imperius transforms your SEO investment into measurable
              business growth
            </motion.p>
          </motion.div>
                ...
                <CardContent className="p-0">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      />
                      <div className="text-center mt-2 text-crimson font-semibold">
                        ${seoSpend.toLocaleString()}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="w-full"
                        onChange={(e) =>
                          setMonthlyTraffic(parseInt(e.target.value))
                        }
                      />
                      <div className="text-center mt-2 text-crimson font-semibold">
                    ...
                    <div className="bg-obsidian/50 rounded-lg p-6 border border-crimson/20">
                      <h4 className="font-semibold text-white mb-4">
                        Projected Results with Imperius
                      </h4>

                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div>
                          <div className="text-2xl font-bold text-crimson">
                            {roiResults.additionalTraffic.toLocaleString()}
                          </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-platinum/80">
                        Average organic traffic improvement within 90 days of
                ...
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-platinum/80">
                        Reduce content optimization time with
                        intelligence-driven insights
                      </p>
                    </div>
                  </div>
                ...
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-platinum/80">
                        Access insights competitors can't replicate with
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <motion.h2
              ...
              className="font-playfair text-4xl lg:text-5xl font-bold text-white mb-6"
            >
              Proven <span className="text-crimson">Success Stories</span>
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-xl text-platinum/80 mb-12 max-w-3xl mx-auto"
            >
              Real clients, real results, real competitive advantage through
                ...
                <CardContent className="p-0">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-platinum/80 text-sm mb-4">
                      Despite extensive backlink building and keyword
                      optimization, competitors with fewer domain authority and
                      backlinks were consistently outranking them for high-value
                      commercial terms.
                    </p>
                    ...
                    <p className="text-platinum/80 text-sm mb-4">
                      Imperius revealed that top-ranking competitors used more
                      authoritative tone, deeper technical content structure,
                      and better user experience patterns.
                    </p>
              ...
              <Card className="glassmorphism p-8 rounded-2xl h-full">
                <CardContent className="p-0">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-platinum/80 text-sm mb-4">
                      Agency needed to differentiate from competitors and
                      provide deeper insights to retain high-value enterprise
                      clients demanding sophisticated SEO strategy.
                    </p>
                    ...
                    <p className="text-platinum/80 text-sm mb-4">
                      Implemented Imperius as core service offering, providing
                      multi-dimensional content analysis that traditional tools
                      couldn't match.
                    </p>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-platinum/80">
                Combined results across all strategic partners
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.p
              ...
              className="text-xl text-platinum/80 mb-12 max-w-3xl mx-auto"
            >
              Full-stack development expertise with strategic business focus and
          ...
          >
            ...
            <p className="text-platinum/80 max-w-3xl mx-auto">
              Combining technical excellence with business intelligence to
              deliver solutions that drive measurable growth. Specialized in
              full-stack development, strategic analysis, and enterprise-grade
              implementations that create competitive advantages for
      ...
      <section className="py-20 bg-charcoal relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            <motion.h2
              variants={fadeInUp}
              className="font-playfair text-5xl lg:text-6xl font-bold text-white mb-6"
            >
              Stop Guessing.{" "}
              <span className="text-crimson text-shadow-glow">
                Start Dominating.
              </span>
            </motion.h2>
            ...
            <motion.p
              variants={fadeInUp}
              className="text-xl text-platinum/80 mb-8 max-w-3xl mx-auto"
            >
              Join an exclusive cohort of strategic SEO professionals who've
              moved beyond keyword tracking to true competitive intelligence.
            </motion.p>
            ...
            >
              <div className="mb-6">
                ...
                <p className="text-platinum/60 text-sm">
                  Early access includes 1:1 strategic onboarding and priority
                  support.
                </p>
              </div>
              ...
              <Form {...finalForm}>
                <form
                  onSubmit={finalForm.handleSubmit(onSubmit)}
                  className="space-y-4"
                >
                  <FormField
