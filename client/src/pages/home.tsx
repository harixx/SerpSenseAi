        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <Card className="glassmorphism p-8 rounded-2xl h-full relative overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 bg-crimson/10 rounded-full blur-xl" />
                <CardContent className="p-0 relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-crimson/20 to-ruby/20 rounded-lg flex items-center justify-center mb-6">
                    <div className="text-2xl font-bold text-crimson">FS</div>
                  </div>
                  <h3 className="font-playfair text-xl font-semibold text-white mb-4">Full-Stack Architecture</h3>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">React + TypeScript</span>
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Node.js + Express</span>
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">PostgreSQL + Drizzle ORM</span>
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">TailwindCSS + Framer Motion</span>
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                    </div>
                  </div>
                  <p className="text-platinum/70 text-sm">
                    Modern, scalable architecture with type safety, database optimization, and premium user experience
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="glassmorphism p-8 rounded-2xl h-full relative overflow-hidden">
                ...
                <CardContent className="p-0 relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-gold/20 to-amber-600/20 rounded-lg flex items-center justify-center mb-6">
                    <div className="text-2xl font-bold text-gold">BA</div>
                  </div>
                  <h3 className="font-playfair text-xl font-semibold text-white mb-4">Business Analysis</h3>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Market Research & Strategy</span>
                      <div className="w-2 h-2 bg-gold rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">ROI Calculation & Metrics</span>
                      <div className="w-2 h-2 bg-gold rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Customer Journey Optimization</span>
                      <div className="w-2 h-2 bg-gold rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Conversion Rate Analysis</span>
                      <div className="w-2 h-2 bg-gold rounded-full"></div>
                    </div>
                  </div>
                  <p className="text-platinum/70 text-sm">
                    Strategic business intelligence with data-driven decision making and growth optimization
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="glassmorphism p-8 rounded-2xl h-full relative overflow-hidden">
                ...
                <CardContent className="p-0 relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-lg flex items-center justify-center mb-6">
                    <div className="text-2xl font-bold text-blue-400">PM</div>
                  </div>
                  <h3 className="font-playfair text-xl font-semibold text-white mb-4">Project Management</h3>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Agile Development Process</span>
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Stakeholder Communication</span>
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Timeline & Budget Management</span>
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-platinum/80 text-sm">Quality Assurance</span>
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    </div>
                  </div>
                  <p className="text-platinum/70 text-sm">
                    End-to-end project delivery with clear communication, milestone tracking, and quality standards
                  </p>
                </CardContent>
              </Card>
            </motion.div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-crimson/10 to-gold/10 rounded-2xl p-8 mb-16"
          >
            <div className="text-center mb-8">
              <h3 className="font-playfair text-2xl font-semibold text-white mb-2">Development Process Excellence</h3>
              <p className="text-platinum/80">Proven methodologies for consistent, high-quality deliveries</p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-crimson/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="text-xl font-bold text-crimson">1</div>
                </div>
                <h4 className="font-semibold text-white mb-2">Discovery & Strategy</h4>
                <p className="text-platinum/70 text-sm">Requirements analysis, market research, and strategic planning</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-gold/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="text-xl font-bold text-gold">2</div>
                </div>
                <h4 className="font-semibold text-white mb-2">Design & Architecture</h4>
                <p className="text-platinum/70 text-sm">System design, database modeling, and user experience planning</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-platinum/70 text-sm">Agile development with continuous integration and quality assurance</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <div className="text-xl font-bold text-green-400">4</div>
                </div>
                <h4 className="font-semibold text-white mb-2">Deploy & Optimize</h4>
                <p className="text-platinum/70 text-sm">Production deployment, performance monitoring, and continuous improvement</p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="font-playfair text-3xl font-semibold text-white mb-6">Portfolio Highlights</h3>
              
              <div className="space-y-6">
                <Card className="glassmorphism p-6 rounded-xl border border-crimson/20">
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-crimson/20 rounded-lg flex items-center justify-center">
                        <Code className="text-crimson text-xl" />
                      </div>
                      <div>
                        <h4 className="font-playfair text-lg font-semibold text-white mb-2">SERP Intelligence Platform</h4>
                        <p className="text-platinum/80 text-sm mb-3">
                          Full-stack SEO analytics platform with PostgreSQL database, real-time calculations, 
                          and premium user experience design
                        </p>
                        <div className="flex flex-wrap gap-2">
                          <span className="px-3 py-1 bg-crimson/20 text-crimson text-xs rounded-full">React</span>
                          <span className="px-3 py-1 bg-crimson/20 text-crimson text-xs rounded-full">TypeScript</span>
                          <span className="px-3 py-1 bg-crimson/20 text-crimson text-xs rounded-full">PostgreSQL</span>
                          <span className="px-3 py-1 bg-crimson/20 text-crimson text-xs rounded-full">Framer Motion</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="glassmorphism p-6 rounded-xl border border-gold/20">
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-gold/20 rounded-lg flex items-center justify-center">
                        <BarChart3 className="text-gold text-xl" />
                      </div>
                      <div>
                        <h4 className="font-playfair text-lg font-semibold text-white mb-2">Interactive ROI Calculator</h4>
                        <p className="text-platinum/80 text-sm mb-3">
                          Real-time business impact calculator with dynamic visualizations and 
                          lead qualification capabilities
                        </p>
                        <div className="flex flex-wrap gap-2">
                          <span className="px-3 py-1 bg-gold/20 text-gold text-xs rounded-full">JavaScript</span>
                          <span className="px-3 py-1 bg-gold/20 text-gold text-xs rounded-full">Business Logic</span>
                          <span className="px-3 py-1 bg-gold/20 text-gold text-xs rounded-full">UX Design</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="glassmorphism p-6 rounded-xl border border-blue-400/20">
                  <CardContent className="p-0">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-blue-400/20 rounded-lg flex items-center justify-center">
                        <Database className="text-blue-400 text-xl" />
                      </div>
                      <div>
                        <h4 className="font-playfair text-lg font-semibold text-white mb-2">Database Architecture</h4>
                        <p className="text-platinum/80 text-sm mb-3">
                          Enterprise-grade database design with Drizzle ORM, migrations, 
                          and production-ready deployment strategies
                        </p>
                        <div className="flex flex-wrap gap-2">
                          <span className="px-3 py-1 bg-blue-400/20 text-blue-400 text-xs rounded-full">PostgreSQL</span>
                          <span className="px-3 py-1 bg-blue-400/20 text-blue-400 text-xs rounded-full">Drizzle ORM</span>
                          <span className="px-3 py-1 bg-blue-400/20 text-blue-400 text-xs rounded-full">Migrations</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <Card className="glassmorphism p-8 rounded-2xl">
                <CardContent className="p-0">
                  ...
                  <div className="grid grid-cols-2 gap-6 text-center mb-8">
                    <div>
                      <div className="text-3xl font-bold text-crimson mb-2">100%</div>
                      <div className="text-sm text-platinum/60">Project Success Rate</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-gold mb-2">48hr</div>
                      <div className="text-sm text-platinum/60">Avg. Response Time</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-green-400 mb-2">15+</div>
                      <div className="text-sm text-platinum/60">Tech Stack Mastery</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-blue-400 mb-2">5yrs</div>
                      <div className="text-sm text-platinum/60">Industry Experience</div>
                    </div>
                  </div>

                  <div className="border-t border-crimson/20 pt-6">
                    <h4 className="font-semibold text-white mb-4">Core Competencies</h4>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-platinum/80 text-sm">Full-Stack Development</span>
                        <div className="flex space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <div key={i} className="w-2 h-2 bg-crimson rounded-full"></div>
                          ))}
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-platinum/80 text-sm">Business Strategy</span>
                        <div className="flex space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <div key={i} className="w-2 h-2 bg-gold rounded-full"></div>
                          ))}
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-platinum/80 text-sm">Database Design</span>
                        <div className="flex space-x-1">
                          {[...Array(5)].map((_, i) => (
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-platinum/80 text-sm">UI/UX Design</span>
                        <div className="flex space-x-1">
                          {[...Array(4)].map((_, i) => (
